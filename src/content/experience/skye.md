...
- Engineered backend systems leveraging **Django** for scalable web applications, **REST** and **GraphQL APIs** for seamless data exchange, **React.js** and **Vue.js** for dynamic user interfaces, and **Docker** and **Kubernetes** for containerized deployments.
