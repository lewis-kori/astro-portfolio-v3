...
author: Lewis Kori
tags: ["artificial intelligence", "software engineering", "ai agents", "future of work", "systems thinking"]
series: Human + AI
description: A software engineer reflects on how AI agents are reshaping engineering work, job expectations, and the definition of leverage in the age of AI.
...
While navigating this shift, I started reading [AI 2041: Ten Visions for Our Future by Kai-Fu Lee and Chen Qiufan](https://a.co/d/01NkYYVm).
...
[Variant](https://variant.com/) is closer to an AI-native website design tool than a coding assistant. Conceptually, it sits nearer to design platforms like [Figma make](https://www.figma.com/make/) or emerging AI-enhanced layout builders.
